...
class KalshiWebsocket:
    ...
    async def connect(self):
        ...
        Generates connection failure exception after retry logic
        fails.
        '''
    ...
    async def rebuild_on_gap(self, ticker):
        '''
    ...
    def _handle_gap(self, ticker: str):
        '''
    ...
    async def handle_msg(self, message):
        ...
        Generates Websocket Auth exception on 401 error.
        '''
